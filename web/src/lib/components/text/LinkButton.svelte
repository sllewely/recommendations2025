<script lang="ts">
	...
	let default_color_class =
		"bg-transparent hover:bg-orange-500 text-teal-700 border-teal-500 bg-white";
...
<a href={url}>
	<button class="{color_class} font-bold py-2 px-4 border rounded">
		<slot />
	</button>
</a>
