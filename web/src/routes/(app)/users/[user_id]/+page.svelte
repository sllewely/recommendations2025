...
<div>
	<span onclick={() => (selected = "activity")}
		><ToggleButton selected={selected === "activity"}>Activity</ToggleButton></span
	>
	<span onclick={() => (selected = "recommendations")}
		><ToggleButton selected={selected === "recommendations"}>Recommendations</ToggleButton></span
	>
</div>
